...
def addGrain(im):
    ...
    print("traitement du rouge")
    rouge = evaluation(imrouge)
    print("traitement du vert")
    vert = evaluation(imvert)
    bleu = evaluation(imbleu)
    
    #concaténation des 3 canaux
    imf = [[0]*M_zoom for _ in range(N_zoom)]
